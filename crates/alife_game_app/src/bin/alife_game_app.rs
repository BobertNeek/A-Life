...
use alife_game_app::{
    ...
    run_graphical_population_smoke, run_graphical_save_load_menu_smoke, run_hazard_recovery_smoke,
    ...
    run_longrun_balance_smoke, run_motor_ring_arbitration_smoke, run_onboarding_help_smoke,
