...
use alife_core::{
    ActionId, ActionKind, ActionProposal, ActionTarget, BrainGenome, BrainScaleTier,
    BrainTickInput, BrainTickStatus, Confidence, CreatureMind, DurationTicks, GenomeId,
    HomeostaticSnapshot, Intensity, LineageId, NormalizedScalar, OrganismId, PhysicalContactKind,
    ReferenceActionFailure, ScaffoldContractError, SleepPhase, Tick, Validate, Vec3f,
    WorldEntityId,
};
