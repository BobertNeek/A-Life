...
use alife_core::{
    ...
    ActionTarget, BrainGenome, BrainScaleTier, BrainTickInput, BrainTickStatus, Confidence,
    CreatureMind, DurationTicks, GenomeId, HomeostaticSnapshot, Intensity, LineageId,
