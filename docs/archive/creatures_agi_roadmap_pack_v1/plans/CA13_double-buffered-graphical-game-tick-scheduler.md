...
## Objective
Align render frames with fixed physiological/neural ticks without drift.

## Dependencies
CAR12

## Owned scope
alife_game_app live brain bridge/scheduler; core only if no alternative.

## Required work
- Fixed simulation tick cadence.
- Render interpolation state.
- No frame-driven cognition drift.
- Pause/step/run semantics precise.
- Metrics for tick/frame timing.
...
```text
CA13 receipt
Plan: Double-buffered graphical/game tick scheduler
Branch:
Files changed:
