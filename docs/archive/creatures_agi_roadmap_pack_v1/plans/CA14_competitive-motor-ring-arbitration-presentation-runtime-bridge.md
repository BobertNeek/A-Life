...
## Objective
Expose and, where needed, implement efficient action-channel competition without global sort-heavy paths.

## Dependencies
CA13

## Owned scope
alife_core only if explicit small contract is necessary; app visualization.

## Required work
- Audit existing P09 arbitration.
- Add motor-ring-compatible proposal envelope if missing.
- Visualize competing action channels.
- Preserve structured arbitration.
...
```text
CA14 receipt
Plan: Competitive motor ring arbitration presentation/runtime bridge
Branch:
Files changed:
