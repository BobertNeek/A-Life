...
## Objective
Creature visibly approaches and interacts with food through normal action path.

## Dependencies
CA15

## Owned scope
alife_world + alife_game_app; core only if needed.

## Required work
- World position updates visible.
- Approach/eat action envelopes.
- Food consumption changes resource state.
- Energy/reward changes visible.
- No scripted action forcing.
...
```text
CA16 receipt
Plan: Non-scripted movement, approach, eat, and affordance loop
Branch:
Files changed:
