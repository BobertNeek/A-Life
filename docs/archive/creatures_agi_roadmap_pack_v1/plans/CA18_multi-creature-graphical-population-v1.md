...
## Objective
Render and update multiple creatures in the graphical world.

## Dependencies
CAR17

## Owned scope
alife_game_app/alife_world.

## Required work
- Spawn N creatures from manifest.
- Stable-ID selection cycles.
- Per-creature inspector.
- Basic social proximity cues.
...
```text
CA18 receipt
Plan: Multi-creature graphical population v1
Branch:
Files changed:
