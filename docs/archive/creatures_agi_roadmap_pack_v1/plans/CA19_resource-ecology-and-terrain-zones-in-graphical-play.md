...
## Objective
Make resource cycles and terrain zones visible and persistent.
...
- Resource regen/depletion.
- Food spawned/regrown indicators.
- Hazard pressure zones.
- Save/load roundtrip.
...
```text
CA19 receipt
Plan: Resource ecology and terrain zones in graphical play
Branch:
Files changed:
