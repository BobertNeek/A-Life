...
## Objective
Make teacher cues feel like world events, not hidden metadata.
...
## Required work
- Teacher emits visible/audible token objects.
- Gesture/speech markers.
- No direct motor bypass.
- Lesson conditions are sensory/environmental.
- Tests for bypass rejection.
...
```text
CA24 receipt
Plan: Teacher avatar, gestures, speech tokens, and perception-only gating
Branch:
Files changed:
