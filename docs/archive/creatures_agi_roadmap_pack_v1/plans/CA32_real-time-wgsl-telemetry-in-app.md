...
## Objective
Add GPU timing telemetry for active frame/tick markers.

## Dependencies
CAR31

## Owned scope
gpu_backend/app/tools.

## Required work
- Per-frame/tick timing capture.
- Upload/compute/readback split.
- Tile/routing counters.
- UI summary.
- No blocking hot path if unavailable.
...
```text
CA32 receipt
Plan: Real-time WGSL telemetry in app
Branch:
Files changed:
