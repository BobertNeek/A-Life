...
## Objective
Batch GPU static/plastic operations across creatures where safe.

## Dependencies
CA32

## Owned scope
gpu_backend/app/world; no core deps.

## Required work
- Batch buffer layout.
- Per-creature compact summaries.
- CPU shadow parity sample/every tick config.
- Fallback per batch.
- Performance report.
...
```text
CA33 receipt
Plan: Batched multi-creature GPU runtime
Branch:
Files changed:
