...
## Objective
Add small stylized terrain/prop visuals inspired by Creatures-like observability.
...
## Required work
- Tiny procedural/shape assets or small versioned assets.
- Terrain tiles/props.
- No large binary dump.
- Readable color language.
...
```text
CA37 receipt
Plan: Terrain, props, and world art style pass
Branch:
Files changed:
