...
## Objective
Make creature state readable through simple animation and pose changes.
...
## Required work
- Idle/move/eat/flee/sleep/pain/social animations.
- Presentation only.
- Inspector stays accurate.
- Fallback states visible.
- Tests for mapping.
...
```text
CA38 receipt
Plan: Creature animation state machine
Branch:
Files changed:
