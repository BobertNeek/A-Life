...
## Objective
Map neurochemical/survival milestones to player-readable audio/VFX cues.
...
## Required work
- Hunger satisfaction cue.
- Hazard pain cue.
- Sleep/rest cue.
- Learning pulse.
- Optional audio; no large assets.
...
```text
CA39 receipt
Plan: Drive-coupled audio and VFX
Branch:
Files changed:
