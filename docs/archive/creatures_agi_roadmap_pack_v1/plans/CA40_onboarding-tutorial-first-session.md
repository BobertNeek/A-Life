...
## Objective
Guide a new player through observing and controlling the first creature.
...
- Tutorial panel.
- Checklist tasks.
- Pause/step/follow instructions.
- Food/hazard explanation.
- GPU/fallback explanation.
...
```text
CA40 receipt
Plan: Onboarding tutorial first session
Branch:
Files changed:
