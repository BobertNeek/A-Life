...
## Objective
Run structured external tester loops and triage findings.

## Dependencies
CA43

## Owned scope
docs/app/tests; fixes only if evidence-driven.

## Required work
- Tester matrix.
- Intake reports.
- Severity triage.
- Fix blocker/high only.
- Beta criteria.
...
```text
CA44 receipt
Plan: External alpha/beta playtest loop
Branch:
Files changed:
