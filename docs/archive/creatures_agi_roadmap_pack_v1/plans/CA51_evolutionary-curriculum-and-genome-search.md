...
## Objective
Search lineages/curricula for robust learners under bounded compute.
...
## Required work
- Genome lab scenarios.
- Fitness metrics.
- Diversity preservation.
- No Lamarckian genetic mutation unless explicit.
- Artifact policy.
...
```text
CA51 receipt
Plan: Evolutionary curriculum and genome search
Branch:
Files changed:
