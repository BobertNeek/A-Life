...
## Objective
Evaluate sleep, consolidation, and lifetime learning across curricula.
...
## Required work
- Sleep curriculum scenarios.
- Memory stability metrics.
- Catastrophic forgetting checks.
- H_shadow/lifetime separation.
- Reports.
...
```text
CA52 receipt
Plan: Sleep/consolidation curriculum and long-horizon memory
Branch:
Files changed:
