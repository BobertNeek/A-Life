...
## Objective
Study token grounding and communication in multi-agent ecology.

## Dependencies
CA54

## Owned scope
school/semantic/world/tools.

## Required work
- Communication scenarios.
- Token grounding metrics.
- No teacher motor bypass.
...
```text
CA55 receipt
Plan: Emergent language and social communication research
Branch:
Files changed:
