...
## Objective
Review whether survival loop is visibly non-scripted enough for alpha. Stop for user/ChatGPT before population expansion.
...
`docs/creatures_agi_roadmap_pack/reviews/CAR17_REVIEW_REPORT.md`
