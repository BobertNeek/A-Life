...
Additional instruction: Work in single-agent mode. Begin with P00. Continue through the next unblocked plan after each successful completion. Stop only at explicit merge gates, unrecoverable validation failure, or when all plans are complete.
