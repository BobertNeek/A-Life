...
| P04.5 | codex/P04.5-performance-contract | complete | local branch | passed: fmt, check, test, clippy, Git Bash `scripts/check.sh`, Git Bash `scripts/check_core_boundaries.sh` | P05/P06/P07/P08/P09 |
