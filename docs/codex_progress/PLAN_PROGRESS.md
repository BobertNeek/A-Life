...
| P17 | codex/P17-headless-world-harness | complete | local branch commit; see receipt | P17 validation command set recorded in completion receipt | P18/P19/P20 |
...
| P25 | codex/P25-gpu-static-forward-parity | complete | local branch commit; see receipt | passed: focused P25 tests, manual ignored GPU parity, fmt, check, test, all-features check/test, clippy, GPU-feature clippy, Git Bash `scripts/check.sh`, Git Bash `scripts/check_core_boundaries.sh`, `cargo tree -p alife_core`, Graphify update | P26 |
| P26 | codex/P26-gpu-plasticity-oja | complete | local branch commit; see receipt | passed: focused P26 tests, ignored/manual long-run saturation smoke, ignored/manual P26 GPU parity, ignored/manual P25 GPU parity, fmt, check, test, all-features check/test, clippy, GPU-feature clippy, Git Bash `scripts/check.sh`, Git Bash `scripts/check_core_boundaries.sh`, `cargo tree -p alife_core` | P27 |
