...
| P02 | codex/P02-traceability-invariants | complete pending commit | local branch | passed: fmt, check, test, boundary self-test, boundary check, aggregate `scripts/check.sh`, clippy | P03 |
