...
| P04 | codex/P04-abi-validation-errors | complete pending commit | local branch | passed: fmt, check, test, boundary check, aggregate `scripts/check.sh`, clippy | P05/P06/P07/P08/P09 |
