...
| P23 | codex/P23-school-teacher | complete | local branch commit; see receipt | passed: focused P23 tests, fmt, check, test, all-features check/test, clippy, Git Bash `scripts/check.sh`, Git Bash `scripts/check_core_boundaries.sh`, `cargo tree -p alife_core`, Graphify update | P18/P35 |
