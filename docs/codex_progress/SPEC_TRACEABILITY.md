...
| Runtime ExperiencePatch remains separate from packed logs | ExperiencePatch / packed logging split | P10/P11 | `crates/alife_core/src/experience.rs`; future packed log module | `crates/alife_core/tests/experience_three_phase.rs`; P11 packed tests pending | complete for P10 runtime contract; P11 packed export still pending |
