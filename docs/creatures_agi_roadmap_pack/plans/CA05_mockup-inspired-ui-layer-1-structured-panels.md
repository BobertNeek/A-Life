...
## Objective
Replace debug text-wall with structured player-facing panels inspired by the visual target.

## Dependencies
CAR04

## Owned scope
alife_game_app Bevy UI only.
...
- Bottom controls bar.
- Bottom event feed.
- Footer with CPU-shadow boundary and product claim.
...
```text
CA05 receipt
Plan: Mockup-inspired UI layer 1: structured panels
Branch:
Files changed:
