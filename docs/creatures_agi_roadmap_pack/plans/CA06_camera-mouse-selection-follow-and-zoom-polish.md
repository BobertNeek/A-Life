...
## Objective
Make camera and selection usable for a player.

## Dependencies
CA05

## Owned scope
alife_game_app Bevy shell and adapter use; no core changes.

## Required work
- Mouse click/select by stable-ID mapped entity.
- Keyboard pan/zoom/orbit remains.
- F follow selected creature.
- Selected ring and camera focus are visible.
- No Bevy Entity IDs in UI.
...
```text
CA06 receipt
Plan: Camera, mouse selection, follow, and zoom polish
Branch:
Files changed:
