...
## Objective
Add readable feedback cues without large assets.

## Dependencies
CA07

## Owned scope
alife_game_app presentation/assets manifest if tiny.

## Required work
- Procedural visual pulse for reward/pain/sleep/learning.
- Optional minimal audio cue stubs behind feature/config.
- No large audio files.
- Events remain presentation-only.
- Docs list cue meanings.
...
```text
CA08 receipt
Plan: First sensory feedback layer: VFX and procedural audio stubs
Branch:
Files changed:
