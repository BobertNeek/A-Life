...
## Objective
Make save/load accessible from the graphical app.

## Dependencies
CAR08

## Owned scope
alife_game_app UI + alife_world persistence integration.

## Required work
- Open save/load menu from UI/key.
- Manual save slot and load slot.
- Readable errors for invalid asset/config/save.
- Stable IDs only.
- No partial load after error.
...
```text
CA09 receipt
Plan: Player-facing save/load menu in graphical app
Branch:
Files changed:
