...
## Objective
Launch arenas from versioned manifest/config instead of hardcoded P34 path.

## Dependencies
CA09

## Owned scope
alife_game_app, alife_world persistence/config, docs.

## Required work
- Read central environment manifest.
- List/select alpha scenarios.
- Validate terrain/resource/creature starter setup.
- Errors are player-readable.
- No manual command checkout required for known scenarios.
...
```text
CA10 receipt
Plan: Configuration-driven environment launcher
Branch:
Files changed:
