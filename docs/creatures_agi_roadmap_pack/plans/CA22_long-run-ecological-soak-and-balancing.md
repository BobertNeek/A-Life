...
## Objective
Run long-form graphical/headless ecology soaks and tune obvious degeneracies.

## Dependencies
CA21

## Owned scope
configs/world/app/tools; core only for bugs.

## Required work
- Manual 10k tick headless ecology soak.
- Graphical bounded soak.
- Record survival/resource/population metrics.
- Tune only config-first unless bug.
...
```text
CA22 receipt
Plan: Long-run ecological soak and balancing
Branch:
Files changed:
