...
## Objective
Make school/teacher mode visible and togglable in the app.

## Dependencies
CAR22

## Owned scope
alife_game_app/alife_school integration.

## Required work
- School mode toggle.
- Teacher avatar/cue marker.
- Lesson panel.
- Verifier panel uses sealed patches.
- Perception-only boundary visible.
...
```text
CA23 receipt
Plan: Graphical school mode and lesson panel
Branch:
Files changed:
