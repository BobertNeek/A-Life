...
## Objective
Add an optional real semantic provider boundary without action/weight authority.

## Dependencies
CA25

## Owned scope
alife_semantic/app; no core direct authority.

## Required work
- Provider trait for local/offline model or service.
- Config/manifest.
- Timeout/fallback.
- Context vectors bounded.
- Cannot act/rewrite weights.
...
```text
CA26 receipt
Plan: Real semantic provider adapter v1
Branch:
Files changed:
