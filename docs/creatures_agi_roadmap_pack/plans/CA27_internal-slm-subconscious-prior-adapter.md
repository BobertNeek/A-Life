...
## Objective
Integrate an optional private semantic prior that biases context but cannot act.

## Dependencies
CA26

## Owned scope
semantic/app/school; core only if bounded context contract needed.

## Required work
- Local SLM adapter boundary.
- Asynchronous queue.
- Lexicon/context projection.
- Budget/timeouts.
- Perception/context only; no action/weight writes.
...
```text
CA27 receipt
Plan: Internal SLM subconscious prior adapter
Branch:
Files changed:
