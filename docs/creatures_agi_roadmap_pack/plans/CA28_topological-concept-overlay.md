...
## Objective
Visualize memory/topology concept cells and gaps in player/dev UI.

## Dependencies
CAR27

## Owned scope
app/core read-only APIs if needed.

## Required work
- Concept node overlay.
- Edges/gaps visualization.
- Link to behavior events.
- Read-only snapshots.
- No topology action bypass.
...
```text
CA28 receipt
Plan: Topological concept overlay
Branch:
Files changed:
