...
## Objective
Let players/devs compare creatures/scenarios without mutating live cognition.
...
- A/B scenario runner.
- Behavior signatures.
- Creature comparison panel.
- Export small reports.
- No hidden training mutation.
...
```text
CA31 receipt
Plan: Player lab tools for behavior comparison
Branch:
Files changed:
