...
## Objective
Fuzz compact GPU/CPU parity across fixtures and random seeds.

## Dependencies
CA34

## Owned scope
gpu_backend/tests/tools.

## Required work
- Property tests.
- Random bounded fixtures.
- Static/routing/plastic parity.
- Failure shrink/repro output.
- CI-safe subset.
...
```text
CA35 receipt
Plan: Property-fuzz CPU/GPU parity gating
Branch:
Files changed:
