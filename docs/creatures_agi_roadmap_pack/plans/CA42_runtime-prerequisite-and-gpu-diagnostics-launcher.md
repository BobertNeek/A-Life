...
## Objective
Add a preflight that diagnoses GPU/windowing and falls back or errors clearly.
...
## Required work
- GPU probe.
- Driver/backend display.
- Missing Vulkan/DX guidance.
- CPU fallback option.
- Log file path.
...
```text
CA42 receipt
Plan: Runtime prerequisite and GPU diagnostics launcher
Branch:
Files changed:
