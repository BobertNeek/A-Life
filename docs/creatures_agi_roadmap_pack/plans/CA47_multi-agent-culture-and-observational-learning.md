...
## Objective
Study learned social cues, imitation-like perception, and cultural transmission in bounded worlds.

## Dependencies
CA46

## Owned scope
world/app/core read-only contracts as needed.

## Required work
- Social signal scenarios.
- Non-authoritative imitation cues.
- Culture metrics.
- Lineage memory reports.
- No direct action copying.
...
```text
CA47 receipt
Plan: Multi-agent culture and observational learning
Branch:
Files changed:
