...
## Objective
Benchmark against explicit Creatures-like behavioral criteria without copying proprietary assets.

## Dependencies
CAR52

## Owned scope
tools/world/app/docs.

## Required work
- Baseline criteria.
- Food/sleep/fear/social/learning tasks.
- Human-observable rubric.
- Long-run metrics.
- Reports.
...
```text
CA53 receipt
Plan: Creatures-inspired baseline benchmark suite
Branch:
Files changed:
