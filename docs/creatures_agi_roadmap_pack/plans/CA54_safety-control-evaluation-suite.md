...
## Objective
Evaluate boundaries, corrigibility-like controls, pause/reset, and unsafe hidden channels.
...
## Required work
- Pause/reset tests.
- Teacher/semantic bypass tests.
- Weight mutation boundary tests.
- Runaway population tests.
- Report.
...
```text
CA54 receipt
Plan: Safety/control evaluation suite
Branch:
Files changed:
