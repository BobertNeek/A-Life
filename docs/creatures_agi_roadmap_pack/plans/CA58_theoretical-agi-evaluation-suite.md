...
## Objective
Define and run a battery of cognitive-school evaluations for open-ended agent capability.
...
- Autonomy boundaries.
- Safety gates.
- Claim levels: no AGI / proto-cognitive / research milestone.
...
```text
CA58 receipt
Plan: Theoretical AGI evaluation suite
Branch:
Files changed:
