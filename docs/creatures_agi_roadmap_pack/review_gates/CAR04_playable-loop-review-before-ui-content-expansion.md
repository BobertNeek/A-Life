...
## Objective
Audit whether a first user can press Space/N and see meaningful creature/world changes. Stop for ChatGPT/user review.
...
`docs/creatures_agi_roadmap_pack/reviews/CAR04_REVIEW_REPORT.md`
