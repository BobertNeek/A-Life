...
## Objective
Review save/load, config-driven launch, sandbox editing, stable IDs, and asset manifests before core gameplay expansion.
...
`docs/creatures_agi_roadmap_pack/reviews/CAR12_REVIEW_REPORT.md`
