...
## Objective
Review whether the game has a living ecosystem baseline. Stop before school/semantic expansion.
...
`docs/creatures_agi_roadmap_pack/reviews/CAR22_REVIEW_REPORT.md`
