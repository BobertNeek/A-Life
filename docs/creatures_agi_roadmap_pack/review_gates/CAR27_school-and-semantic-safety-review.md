...
## Objective
Review perception-only boundaries, semantic/SLM safety, no hidden action path, and UX before cognition visualization.
...
`docs/creatures_agi_roadmap_pack/reviews/CAR27_REVIEW_REPORT.md`
