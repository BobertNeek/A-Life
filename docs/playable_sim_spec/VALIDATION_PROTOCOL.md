...
## Additional game-phase validation

Each G-plan must add focused tests for its product behavior. Graphical and GPU hardware tests may be manual/ignored only when they cannot run in CI; exact commands and limitations are required.
