...
if ([string]::IsNullOrWhiteSpace($ModelPath)) {
    $ModelPath = Join-Path $repoRoot "models\local\qwen3-embedding-0.6b-gguf\Qwen3-Embedding-0.6B-Q8_0.gguf"
}
...
Write-Host "Starting A-Life llama.cpp embedding provider on 127.0.0.1:$Port"
